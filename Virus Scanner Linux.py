...
md5 = hashlib.md5()
Vlog = "/home/attila/Desktop/Vlog.txt"
...
print "Directory changed successfully to %s" % workingdir + "\n"  #Prints the changed directory for reference

seq = []
for root, dirs, files in os.walk(path, onerror=None, topdown=True,
                                 followlinks=False):  #Scan directories and files in the path variable
